import 'package:egrocer/helper/generalWidgets/productListRatingBuilderWidget.dart';
import 'package:egrocer/helper/generalWidgets/ratingImagesWidget.dart';
import 'package:egrocer/helper/utils/generalImports.dart';
import 'package:egrocer/models/productRating.dart';
import 'package:egrocer/screens/productDetailScreen/widget/otherImagesViewWidget.dart';
import 'package:egrocer/screens/productDetailScreen/widget/productDetailAddToCartButtonWidget.dart';
import 'package:egrocer/screens/productDetailScreen/widget/productDetailImportantInformationWidget.dart';

Widget ProductDetailWidget(BuildContext context, ProductData product) {
  return Column(
    ...
    children: [
      ...
      Container(
        padding:
            EdgeInsetsDirectional.only(top: 10, start: 10, end: 10, bottom: 10),
          ...
          builder: (context, selectedVariantItemProvider, _) {
            return Column(
              ...
              children: [
                ...
                getSizedBox(height: Constant.size10),
                ProductDetailAddToCartButtonWidget(context, product),
              ],
            );
          },
        ),
      ),
      ProductDetailImportantInformationWidget(context, product),
      getSizedBox(height: Constant.size10),
                ...
                child: Column(
                  children: [
                    getSpecificationItem(
                      ...
                      value: product.fssaiLicNo.toString(),
                      voidCallback: () {},
                      isClickable: false,
                    ),
                    getSpecificationItem(
                      titleJson: "category",
                      value: product.categoryName.toString(),
                      voidCallback: () {
                        Navigator.pushNamed(
                          context,
                          productListScreen,
                    ...
                    getSpecificationItem(
                      ...
                      voidCallback: () {
                        Navigator.pushNamed(
                          ...
                          arguments: [
                            "country",
                            product.madeInId.toString(),
                            product.madeIn.toString(),
                          ],
                        );
                      },
                      isClickable: true,
