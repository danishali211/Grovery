import 'package:egrocer/helper/generalWidgets/bottomSheetThemeListContainer.dart';
      ...
      if (Constant.session.isUserLoggedIn())
        {
          ...
          "value": CustomTextLabel(
            text:
                "${context.watch<SessionManager>().getData(SessionManager.keyWalletBalance)}"
                    .currency,
              ...
              children: List.generate(
                ...
                (index) => Column(
                  children: [
                    ...
                    getDivider(
                      color:
                          fontColor ?? ColorsRes.mainTextColor.withOpacity(0.5),
                    ),
                  ],
                ),
              ),
